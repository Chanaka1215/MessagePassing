...
public class MyService extends Service {
    ...
    final Messenger mMessenger = new Messenger(new MainActivity.IncomingHandler()); // Target we publish for clients to send messages to IncomingHandler.
    ...
    private void showNotification() {
        ...
        Notification notification = new Notification.Builder(this)
                ...
                .build();//Notification(android.R.drawable.btn_dialog, text, System.currentTimeMillis());
    ...
    private void onTimerTick() {
        Log.i("TimerTick", "Timer doing work." + mCounter);
        try {
